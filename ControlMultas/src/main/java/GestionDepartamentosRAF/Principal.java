        ...
        do {
            ...
            switch (op) {
                case 1:
                    ...
                    d = new Departamento(name, nameBoss, numEm,numPlanta,puerta);
                    cd.alta(d);
                    break;
                ...
                case 2:
                    ...
                    int dep2= Integer.parseInt(sc.nextLine());
                    cd.baja(dep2);
                    break;
                ...
                case 3:
                    ...
                    System.out.println("INTRODUCE NUMERO DE PUERTA.");
                    String numPuerta3 = sc.nextLine();
                    d3 = new Departamento(name3, nameBoss3, numEm3,numPlanta3,numPuerta3);
                    cd.modificacion(dep3,d3);
                    break;
